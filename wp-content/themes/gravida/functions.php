...
define('SKT_THEME_URL_DIRECT','http://www.sktthemes.net/shop/gravida-corporate-wordpress-theme/');
define('SKT_THEME_DOC','http://sktthemesdemo.net/documentation/gravida-documentation/');
define('SKT_PRO_THEME_URL','http://www.sktthemes.net/shop/gravida-corporate-wordpress-theme/');
